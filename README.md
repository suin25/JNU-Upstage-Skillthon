...
python main.py summary --month 2026-04
```
...
python main.py report --month 2026-04 --income 3500000
```
...
python ocr_extract.py --image ../receipt.jpg --save

# 분석만 테스트
python analyze.py --month 2026-05
python analyze.py --report --income 3000000

# 즉시 경고 테스트
python analyze.py --alert --store 스타벅스 --amount 92000 --category 카페/음료
```
